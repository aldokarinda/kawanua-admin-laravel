        ...
        <div class="bg-white rounded-xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 p-8">
            <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" value="{{ old('name', $permission->name) }}" class="w-full rounded-lg border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-5 py-2.5 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 shadow-sm">Update Permission</button>
                </div>
            </form>
        </div>
    </div>
