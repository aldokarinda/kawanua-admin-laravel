...
<x-admin-layout>
    <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-slate-200 tracking-tight">Edit User: {{ $user->name }}</h2>
                <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">Update user information, department, and roles.</p>
            </div>
            ...
            <div class="space-y-10 divide-y divide-gray-100 dark:divide-slate-700">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-1">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-slate-400">Update the user's basic profile information and department details. Make sure the email is active.</p>
                    </div>
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $user->name) }}" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow" required>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email', $user->email) }}" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow" required>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone_number" value="{{ old('phone_number', $user->phone_number) }}" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">Department</label>
                                    <input type="text" name="department" value="{{ old('department', $user->department) }}" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="password" name="password" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow" placeholder="Leave blank to keep current">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password_confirmation" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow" placeholder="Leave blank to keep current">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                    ...
                                    <label class="inline-flex items-center p-3 border {{ in_array($role->name, $userRoles) ? 'border-blue-500 bg-blue-50' : 'border-gray-200 dark:border-slate-600' }} rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700/50 hover:border-blue-300 transition-colors">
                                        <input type="checkbox" name="roles[]" value="{{ $role->name }}" {{ in_array($role->name, $userRoles) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-slate-700/50 border border-gray-100 dark:border-slate-600 rounded-xl">
                                <label class="flex items-center cursor-pointer">
                                    <div class="relative">
                                        <input type="checkbox" name="is_active" class="sr-only peer" {{ $user->is_active ? 'checked' : '' }}>
