    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Update this role and its assigned permissions.</p>
            </div>
            ...
            <div class="space-y-10 divide-y divide-gray-100 dark:divide-slate-700">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-1">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-slate-400">Update the basic information for this role. Role names should be clear and descriptive.</p>
                    </div>
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $role->name) }}" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5">Description</label>
                                    <input type="text" name="description" value="{{ old('description', $role->description) }}" class="w-full rounded-lg border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm transition-shadow">
                                </div>
                            </div>
                        </div>
                    </div>
