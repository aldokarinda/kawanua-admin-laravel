                                        ...
                                        <div class="bg-gray-50 dark:bg-slate-700/50 rounded-xl p-5 border border-gray-100 dark:border-slate-600">
                                            ...
                                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                                @foreach($perms as $perm)
                                                    <label class="inline-flex items-center bg-white dark:bg-slate-800 p-2.5 rounded-lg border border-gray-200 dark:border-slate-600 cursor-pointer hover:border-blue-300 dark:hover:border-blue-500 transition-colors shadow-sm">
                                                        <input type="checkbox" name="permissions[]" value="{{ $perm->name }}" class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
