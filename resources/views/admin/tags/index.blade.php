        ...
        <div class="mt-4 sm:flex sm:items-center sm:justify-between">
            ...
            @can('tag.create')
                <div class="mt-4 sm:mt-0">
                    <a href="{{ route('admin.tags.create') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 border border-transparent rounded-lg font-medium text-white hover:bg-primary-700">
